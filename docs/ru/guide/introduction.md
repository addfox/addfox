...
| Решение | Сборщик | Опыт разработки | Гибкость |
|------|----------|----------|--------|
| Ручная настройка Webpack/Vite | Самостоятельная конфигурация | Требуется ручная обработка HMR | Полный контроль |
| Plasmo | Parcel | Работает из коробки | Основан на конвенциях, включает облачные сервисы |
| WXT | Vite | Работает из коробки | Основан на конвенциях, богатая экосистема плагинов |
| **Addfox** | **Rsbuild** | **Работает из коробки** | **Минимальные конвенции + AI-нативность** |
