...
| 솔루션 | 빌드 도구 | 버전 | 개발 경험 | 유연성 |
|------|----------|------|----------|--------|
| 수작업 Webpack/Vite | 직접 설정 | - | HMR 수동 처리 필요 | 완전히 제어 가능 |
| Plasmo | Parcel | latest | 바로 사용 가능 | 규약 기반, 클라우드 서비스 포함 |
| WXT | Vite | ^0.20.18 | 바로 사용 가능 | 규약 기반, 풍부한 플러그인 생태계 |
| Extension.js | Rspack | latest | 바로 사용 가능 | 제로 설정, 미니멀 |
| **Addfox** | **Rsbuild 1.7.5** | **0.1.1-beta.12** | **바로 사용 가능** | **최소 규약 + AI 네이티브** |
...
# 또는: pnpm dlx addfox@latest create
